...
const Footer = () => {
    return (
        <footer>
            <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 sm:px-6 lg:space-y-16 lg:px-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        ...
                        <p className="max-w-xs mt-4 text-gray-500">
                            Un blog de cuisine pour vous faire découvrir la cuisine du monde. 
                        </p>
                ...
                <p className="text-xs text-center text-gray-500">&copy; 2024. Recipify. All rights reserved.</p>
            </div>
        </footer>
    )
}
